...
function combineAccessToken() {
  const part1: string | undefined = import.meta.env.VITE_GITHUB_ACCESS_TOKEN_PART1;
  const part2: string | undefined = import.meta.env.VITE_GITHUB_ACCESS_TOKEN_PART2;
